...
func (_q *UserQuery) QueryPhotos() *UserPhotoQuery {
	query := (&UserPhotoClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithPhotos(opts ...func(*UserPhotoQuery)) *UserQuery {
	query := (&UserPhotoClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withPhotos; query != nil {
		if err := _q.loadPhotos(ctx, query, nodes,
			func(n *User) { n.Edges.Photos = []*UserPhoto{} },
			func(n *User, e *UserPhoto) { n.Edges.Photos = append(n.Edges.Photos, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadPhotos(ctx context.Context, query *UserPhotoQuery, nodes []*User, init func(*User), assign func(*User, *UserPhoto)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userphoto.FieldUserID)
	}
	query.Where(predicate.UserPhoto(func(s *sql.Selector) {
