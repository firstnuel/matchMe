...
func (_q *UserInteractionQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(userinteraction.Table, userinteraction.FieldID, selector),
...
func (_q *UserInteractionQuery) QueryTargetUser() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserInteractionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserInteractionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserInteractionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserInteractionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserInteractionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *UserInteractionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserInteractionQuery) WithUser(opts ...func(*UserQuery)) *UserInteractionQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserInteractionQuery) WithTargetUser(opts ...func(*UserQuery)) *UserInteractionQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(userinteraction.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserInteraction.Query().
//		Select(userinteraction.FieldUserID).
//		Scan(ctx, &v)
...
func (_q *UserInteractionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserInteraction, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserInteraction, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTargetUser; query != nil {
		if err := _q.loadTargetUser(ctx, query, nodes, nil,
			func(n *UserInteraction, e *User) { n.Edges.TargetUser = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserInteractionQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserInteraction, init func(*UserInteraction), assign func(*UserInteraction, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*UserInteraction)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserInteractionQuery) loadTargetUser(ctx context.Context, query *UserQuery, nodes []*UserInteraction, init func(*UserInteraction), assign func(*UserInteraction, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*UserInteraction)
	for i := range nodes {
...
func (_q *UserInteractionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userinteraction.Table, userinteraction.Columns, sqlgraph.NewFieldSpec(userinteraction.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(userinteraction.FieldUserID)
		}
		if _q.withTargetUser != nil {
			_spec.Node.AddColumnOnce(userinteraction.FieldTargetUserID)
		}
	}
